  ...
  return (
    ...
    id='projects'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl md:mx-auto px-4' >
        ...
        {projectCards.map((card,i)=>(
          <div key={i}>
            <div className='relative w-100 h-100 rounded-full bg-gray-200 flex items-center justify-center'>
              <img
              className='w-60 h-70 shadow-acer'
              src={card.imgLight} alt="project-snaps"/>

              <div className='absolute w-120 h-120 border-50 rounded-full border-neutral-400'>
