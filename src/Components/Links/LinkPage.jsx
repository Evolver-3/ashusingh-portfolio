...
const LinkPage = () => {
  return (
    <PageReuse text={"Links"}>
       <div className='flex gap-4'>
          <LinksBtn href={"https://github.com/Evolver-3"}> 
          <GitSvg/>
          Github</LinksBtn>
