  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center justify-center text-center md:text-left pt-20 h-fit px-40 gap-10 shadow-acer">
      ...
      <div className="order-2 md:order-1 md:w-1/2 text-foreground flex flex-col gap-2">
        ...
        <div className="relative flex gap-7 items-center md:justify-start justify-center"
        >
          ...
          >
            {[0,0.4].map((delay,i)=>(
              <motion.div className="absolute size-5 rounded-full border border-bg-background"
              key={i}
              variants={{
                initial:{
                scale:0.8,opacity:0
          ...
          >
            {[0,0.4].map((delay,i)=>(
              <motion.div className="absolute size-4 rounded-full border border-bg-background"
              key={i}
              variants={{
                initial:{
                scale:0.8,opacity:0
