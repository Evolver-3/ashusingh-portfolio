    ...
    <div className='w-full bg-background my-25 md:my-45 '>
      <div className='flex flex-col md:flex-row items-center justify-between overflow-hidden sm:gap-5 '>
        ...
        viewport={{once:true}}>
          ...
          <HideOut>
            <h2 className=' text-5xl sm:text-7xl font-bold overflow-hidden'>
          ...
          <HideOut>
            <h2
            className='text-xl sm:text-3xl  overflow-hidden'>I'm a <span className='text-fullColor  text-2xl sm:text-4xl'>Frontend Developer</span>
            </h2>
          </HideOut>

          <HideOut>
            <h2
            className='text-xl sm:text-2xl max-w-xl leading-tight  '>A 25 year guy who like to build cool looking websites and deploy them.
            </h2>
          </HideOut>
