...
import AnimatedSvgPath from '../comp/AnimatedSvgPath.jsx'
import LinesAnimated from '../comp/LinesAnimated.jsx'
import BorderAnimate from '../comp/BorderAnimate.jsx'
import  { Css3Wordmark, Html5, Javascript, ReactDark, ReactLight, Tailwindcss } from '../../assets/index.jsx'
import PageReuse from '../comp/PageReuse.jsx'
...
const Skills = ({dark}) => {
  ...
  return (
    <PageReuse text={"Skills"}>
      <motion.div
     className='w-full mx-auto   md:mx-10 flex flex-col md:flex-row justify-around'
     ref={scope}
     >
